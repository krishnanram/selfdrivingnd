...
class Identify():
    ...
    def initializeHeatmap(self, img):
    ...
    def search_windows_extended(self, img, windows):
        ...
        for window in windows:
            ...
            features = self.appendChannels(test_img)
    ...
    def addHeat(self, heatmap, bbox_list):
    ...
    def applyThreshold(self, heatmap, threshold):
    ...
    def getAllSearchWindows(self, img):
    ...
    def getWindowsForRecentRegion(self, img):
    ...
    # To be used between getAllSearchWindows() full's scan of the image
