...
IMAGES__FOR_WRITEUP_DIR     = "./images_for_writeup/"
DATA_DIR                    = "./data/"
...
class Explore():
    ...
    def run(self):
        ...
        cars0 = glob.glob(VEHICLES_DIR + 'GTI_Far/*.png')
        cars1 = glob.glob(VEHICLES_DIR + 'GTI_MiddleClose/*.png')
        cars2 = glob.glob(VEHICLES_DIR + 'GTI_Left/*.png')
        cars3 = glob.glob(VEHICLES_DIR + 'GTI_Right/*.png')
        cars4 = glob.glob(VEHICLES_DIR + 'KITTI_extracted/*.png')
        #cars4 += glob.glob(VEHICLES_DIR + 'augmentation/*.png')
        notcars1 = glob.glob(NON_VEHICLES_DIR + 'Extras/*.png')
        notcars1 += glob.glob(NON_VEHICLES_DIR + 'GTI/*.png')
        ...
        plt.rc('xtick', labelsize=font_size)
        plt.rc('ytick', labelsize=font_size)
        plt.savefig(IMAGES__FOR_WRITEUP_DIR+'car_notcar.png')
